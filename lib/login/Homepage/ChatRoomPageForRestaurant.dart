...
class ChatRoomPageForRestaurant extends StatefulWidget {
  final UserModel targetUser;
  final ChatRoomModel chatRoom;
  final RestaurantModel restaurantModel;
  final User firebaseUser;
  const ChatRoomPageForRestaurant({super.key, required this.targetUser, required this.chatRoom, required this.restaurantModel, required this.firebaseUser});

  @override
  State<ChatRoomPageForRestaurant> createState() => _ChatRoomPageForRestaurantState();
}

class _ChatRoomPageForRestaurantState extends State<ChatRoomPageForRestaurant> {
  ...
  void sendMessage() async {
    ...
    if(msg!=" "){
      ...
      MessageModel newMessage=MessageModel(
          messageid: uuid.v1(),
          sender: widget.restaurantModel.restaurantuid,
                        ...
                        if(snapshot.hasData) {
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Row(
                                mainAxisAlignment: (
                                    currentMessage.sender == widget.restaurantModel.restaurantuid) ?
                                ...
                                children: [
                                  Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: (currentMessage.sender == widget.restaurantModel.restaurantuid) ?
