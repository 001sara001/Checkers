...
class _SignupPageForRestaurantState extends State<SignupPageForRestaurant> {
  ...
  Widget build(BuildContext context) {
    SignupAuthProviderForRestaurant signupAuthProviderForRestaurant =
    Provider.of<SignupAuthProviderForRestaurant>(context);
    return Scaffold(
      appBar: AppBar(
                ...
                Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                            "Already have an account for the restaurant?\t\t"),
                        GestureDetector(
                          onTap: () {
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => LoginPageForRestaurant(),
                              ),
                            );
                          },
